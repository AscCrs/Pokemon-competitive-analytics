...
# URL del torneo
url = 'https://labs.limitlesstcg.com/0026/standings'
...
# Guardar en CSV
df.to_csv('estadisticas_pokemon_mty_2025.csv', index=False, encoding='utf-8')

print("Scraping completado. Archivo guardado como 'estadisticas_pokemon_mty_2025.csv'")
